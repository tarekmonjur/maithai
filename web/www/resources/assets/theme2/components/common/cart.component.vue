...
<!--            </div>-->
    ...
    <modal-component v-if="modal.id === 'Shipping' || modal.id === 'Payment'">
        <shipping-form-component v-if="modal.id === 'Shipping'"></shipping-form-component>
        <payment-form-component v-else-if="Boolean(+settings.enable_payment_method) && modal.id === 'Payment'"></payment-form-component>
    </modal-component>
</template>
