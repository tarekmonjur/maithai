        ...
        <div class="form-row">
            <div class="col">
                <div class="form-group">
                    <label for="variant_id">{{lang('category_id')}} :</label>
                    <select
                        class="form-control form-control-sm"
                        v-model="formInput['variant_id']"
                        :class="{'is-invalid' : errors.variant_id}"
                        id="variant_id">
                        <option v-for="variant in variants" :value="variant.id">{{variant.name}}</option>
                    </select>
                    <div class="invalid-feedback" v-if="errors.variant_id">{{errors.variant_id}}</div>
                </div>
            </div>
        </div>
        <div class="form-row">
...
export default {
    ...
    computed: {
        ...
        variants: function() {
            return _.get(this.$store.state.formData, 'variants.results');
        },
    },
    methods: {
        lang(key) {
